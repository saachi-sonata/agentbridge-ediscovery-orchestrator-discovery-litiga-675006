...
resource "aws_vpc" "main" {
  ...
  tags = {
    blueprint = "eDiscovery Orchestrator • Discovery (Litigation)"
    environment = "production"
    Name = "agentbridge-ediscovery-orchestrator---discovery--lit"
    Environment = "production"
    ManagedBy = "terraform"
  }
}
...
resource "aws_internet_gateway" "main" {
  ...
  tags = {
    Name = "agentbridge-ediscovery-orchestrator---discovery--lit-igw"
  }
}
...
resource "aws_subnet" "public" {
  ...
  tags = {
    Name = "agentbridge-ediscovery-orchestrator---discovery--lit-public"
  }
}
...
resource "aws_route_table" "public" {
  ...
  tags = {
    Name = "agentbridge-ediscovery-orchestrator---discovery--lit-rt"
  }
}
...
resource "aws_security_group" "main" {
  name_prefix = "agentbridge-ediscovery-orchestrator---discovery--lit-"
  vpc_id      = aws_vpc.main.id
  ...
  tags = {
    Name = "agentbridge-ediscovery-orchestrator---discovery--lit-sg"
  }
...
resource "aws_key_pair" "deploy" {
  ...
  key_name   = "agentbridge-ediscovery-orchestrator---discovery--lit"
...
resource "aws_eip" "main" {
  ...
  domain   = "vpc"
  tags = {
    Name = "agentbridge-ediscovery-orchestrator---discovery--lit-eip"
  }
}
...
resource "aws_ebs_volume" "data" {
  ...
  encrypted         = true
  tags = {
    Name = "agentbridge-ediscovery-orchestrator---discovery--lit-data"
  }
}
...
resource "aws_iam_role" "bedrock_flow" {
  ...
  name  = "agentbridge-ediscovery-orchestrator---discovery--lit-bedrock-role"
...
resource "aws_iam_role" "ec2_bedrock" {
  count = var.enable_bedrock ? 1 : 0
  name  = "agentbridge-ediscovery-orchestrator---discovery--lit-ec2-bedrock"
...
resource "aws_iam_instance_profile" "ec2_bedrock" {
  count = var.enable_bedrock ? 1 : 0
  name  = "agentbridge-ediscovery-orchestrator---discovery--lit-ec2-profile"
...
resource "aws_bedrockagent_flow" "main" {
  count              = var.enable_bedrock ? 1 : 0
  name               = "agentbridge-ediscovery-orchestrator---discovery--lit-flow"
